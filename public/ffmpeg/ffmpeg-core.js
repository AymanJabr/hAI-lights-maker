var createFFmpegCore = (() => {
  ...
  return function (createFFmpegCore = {}) {
    ...
    console.log("[ffmpeg-core.js] Script loading and executing.");
    ...
    if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
      ...
      console.log(
        "[ffmpeg-core.js] scriptDirectory calculated as:",
        scriptDirectory,
      );
      {
        read_ = (url) => {
    ...
    console.log("[ffmpeg-core.js] wasmBinaryFile default:", wasmBinaryFile);
    if (!isDataURI(wasmBinaryFile)) {
      wasmBinaryFile = locateFile(wasmBinaryFile);
      console.log(
        "[ffmpeg-core.js] wasmBinaryFile after locateFile:",
        wasmBinaryFile,
      );
    }
    ...
    function instantiateAsync(binary, binaryFile, imports, callback) {
      console.log(
        `[ffmpeg-core.js] instantiateAsync called, binaryFile: ${binaryFile}`,
      );
      if (
        !binary &&
        ...
        console.log(
          `[ffmpeg-core.js] Attempting to stream and instantiate from: ${binaryFile}`,
        );
        return fetch(binaryFile, { credentials: "same-origin" }).then(
          (response) => {
            console.log(
              `[ffmpeg-core.js] Fetch response for ${binaryFile}: ok=${response.ok}, status=${response.status}`,
            );
            if (!response.ok) {
              console.error(
                `[ffmpeg-core.js] Fetch failed with status ${response.status}`,
                response,
              );
            }
            ...
            return result.then(callback, function (reason) {
              console.error(
                `[ffmpeg-core.js] Wasm streaming compile failed: ${reason}`,
              );
          ...
          (fetchError) => {
            console.error(
              `[ffmpeg-core.js] Fetch for ${binaryFile} threw an error:`,
              fetchError,
            );
            throw fetchError;
          },
        ...
        console.log("[ffmpeg-core.js] Falling back to instantiateArrayBuffer");
        return instantiateArrayBuffer(binaryFile, imports, callback);
      }
    }
    function createWasm() {
    ...
    var _ffprobe = (Module["_ffprobe"] = function () {
      return (_ffprobe = Module["_ffprobe"] = Module["asm"]["za"]).apply(
        null,
        arguments,
      );
    });
    ...
    var _emscripten_builtin_memalign = function () {
      return (_emscripten_builtin_memalign = Module["asm"]["Ba"]).apply(
        null,
        arguments,
      );
    };
    ...
    var ___cxa_is_pointer_type = function () {
      return (___cxa_is_pointer_type = Module["asm"]["Fa"]).apply(
        null,
        arguments,
      );
    };
